...
function preLoadPageToCurrentHash() {
	...
	if (typeof currentSearch.item !== "undefined") {
		...
		if (typeof searchResult !== "undefined") {
			...
			textMain += '<a href="https://twitter.com/mypro001" target="_blank"><span class="logoImage"></span></a>';
			textMain += '<a href="https://goo.gl/vFftYE" target="_blank"><span class="titlePage">mypro001</span></a>';
			textMain += '</div>';
			...
			textMain += '<a href="http://mypro001.github.io" target="_blank"><span id="footerInfo">mypro001 &copy; 2017</span></a>';
			textMain += '<a href="https://www.inoreader.com/feed/http://feeds.feedburner.com/mypro001" target="_blank"><span id="footerRSS"></span></a>';
			textMain += '</div>';
			textMain += '</footer>';
			...
			textHTML += '		<title>mypro001 - ' + searchResult.title + '</title>\n';
			...
			textHTML += '		<meta name="keywords" content="mypro001, ' + searchResult.title.split("  ").join(" ").split(" ").join(", ") + '" />\n';
			textHTML += '		<meta property="og:type" content="article" />\n';
			textHTML += '		<meta property="og:title" content="mypro001 - Save big on top quality items on shopping" />\n';
			...
			textHTML += '		<meta property="og:url" content="https://mypro001.github.io/#' + searchResult.search + '" />\n';
			textHTML += '		<meta name="twitter:card" content="summary_large_image" />\n';
			textHTML += '		<meta name="twitter:site" content="@mypro001" />\n';
			textHTML += '		<link rel="canonical" href="https://mypro001.github.io/#' + searchResult.search + '" />\n';
			...
			textHTML += '		<meta name="apple-mobile-web-app-title" content="mypro001" />\n';
			textHTML += '		<meta name="application-name" content="mypro001" />\n';
			...
			textHTML += '		<link rel="alternate" type="application/rss+xml" title="RSS Feed for mypro001" href="http://feeds.feedburner.com/mypro001" />\n';
			textHTML += '		<link rel="stylesheet" href="css/main.css" />\n';
			textHTML += '		<script>(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","https://www.google-analytics.com/analytics.js","ga");ga("create", "UA-92546647-1", "auto");ga("send", "pageview");</script>\n';
			textHTML += '	</head>\n';
			textHTML += '	<body>\n';
	...
	if (App.currentHash !== "") {
		...
		if (typeof searchResult !== "undefined") {
			...
			$("meta[name='keywords']").attr("content", "mypro001, " + searchResult.title.split("  ").join(" ").split(" ").join(", "));
			...
			$("meta[property='og\\:url']").attr("content", "https://mypro001.github.io/#" + searchResult.search);
...
function progressRefresh() {
	$(".progress").css({"width": "" + (App.dataLimit / App.maxSize * 100) + "%"});
}
...
function getRSSPage() {
	//openURL("https://mypro001.github.io/rss/rss.xml");
	//openURL("http://feedly.com/i/subscription/feed/https://mypro001.github.io/rss/rss.xml");
	//openURL("https://www.inoreader.com/feed/https://mypro001.github.io/rss/rss.xml");
	openURL("https://www.inoreader.com/feed/http://feeds.feedburner.com/mypro001");
}

function getmypro001TelegramPage() {
	openURL("http://telegram.me/mypro001");
}
...
$(document).ready(function () {
	...
	textMain += '<div id="navPage"><span id="prevPage" title="&larr;prev"></span>&nbsp;&nbsp;&nbsp;<span id="homePage" title="&uarr;home"></span>&nbsp;&nbsp;&nbsp;<span id="nextPage" title="next&rarr;"></span></div>';
	textMain += '</div>';
	textMain += '</header>';
	textMain += '<div id="mainNavigation">';
	...
	textMain += '</div>';
	textMain += '<main title="&larr;prev &uarr;home next&rarr;">';
	textMain += '<article>';
